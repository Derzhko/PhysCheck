...
public class Teste2Activity extends Activity implements View.OnClickListener{
    ...
    TextView tvtrue, tvfalse, tv1, tv2, tventer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrTv = new TextView[]{tv1, tv2};
        change();
    }

    private void change(){
        if (popitki > 0){
            position = rndposition.nextInt(2);
